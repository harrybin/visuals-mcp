...
const componentCards = [
  ...
  },
  {
    ...
    features: [
      ...
      "Dual-axis and composed charts",
      "JSON, CSV, SVG, JPG export",
    ],
  },
  {
    title: "Image",
    ...
    >
      ...
      >
        ...
        >
          <div
            style={{
              ...
              borderRadius: "28px",
              background:
                "var(--color-background-primary, rgba(255,255,255,0.92))",
              border:
                "1px solid var(--color-border, rgba(148, 163, 184, 0.28))",
          ...
          >
            ...
            <h1
              style={{ fontSize: "3rem", lineHeight: 1.05, margin: "0 0 16px" }}
            >
            ...
            >
              This Storybook is the fastest way to validate the interactive
              components behind the MCP tools exposed by the server. Use it to
              inspect visual states, compare layouts, and verify payload shapes
              before wiring them into prompts or tool outputs.
            </p>
          </div>
          ...
          >
            ...
            <p
              style={{ margin: "0 0 18px", lineHeight: 1.7, color: "#cbd5e1" }}
            >
              Tables, charts, images, master-detail panels, trees, and lists
              share the same MCP App patterns, theme handling, and
        ...
        <section style={{ marginBottom: "32px" }}>
          <h2 style={{ fontSize: "1.85rem", margin: "0 0 16px" }}>
            Component coverage
          </h2>
          <div
            style={{
        ...
        >
          ...
          >
            <h2 style={{ fontSize: "1.7rem", margin: "0 0 14px" }}>
            ...
            >
              <li>
                Single-file app bundles that can be embedded directly in MCP UI
                resources.
              </li>
              <li>
                Interactive states that report back to the model through
                updateModelContext.
              </li>
              <li>
                Theme-aware layouts that behave well inside constrained VS Code
                surfaces.
              </li>
              <li>
                Practical export paths for sharing tables, charts, trees, and
                other visual output.
              </li>
            </ul>
          </div>
          ...
          >
            ...
            >
              <a
                href="https://github.com/harrybin/visuals-mcp"
                target="_blank"
              ...
              <a
                href="https://www.npmjs.com/package/visuals-mcp"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display: "inline-block",
...
const meta: Meta<typeof IntroComponent> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Welcome page for the MCP Visuals Storybook workspace, covering the current interactive UI surface area and validation workflow.",
      },
    },
  },
  tags: ["autodocs"],
