...
const meta: Meta<typeof ListView> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Interactive list component with drag-and-drop reordering, checkboxes, images, and metadata. Supports compact mode and various list item configurations.",
      },
    },
  },
  tags: ["autodocs"],
...
const notificationList: ListItem[] = [
  ...
  },
  {
    ...
    image:
      ...
      <svg width="48" height="48" xmlns="http://www.w3.org/2000/svg">
        <circle cx="24" cy="24" r="24" fill="#2ecc71"/>
        <text x="24" y="32" font-family="Arial" font-size="28" font-weight="bold" fill="white" text-anchor="middle">OK</text>
      </svg>
    `),
  ...
  },
  {
    ...
    image:
      ...
      <svg width="48" height="48" xmlns="http://www.w3.org/2000/svg">
        <circle cx="24" cy="24" r="24" fill="#e74c3c"/>
        <text x="24" y="32" font-family="Arial" font-size="32" font-weight="bold" fill="white" text-anchor="middle">!</text>
      </svg>
    `),
    checked: true,
